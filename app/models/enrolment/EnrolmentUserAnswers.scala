...
final case class EnrolmentUserAnswers(
  ...
  def set[A](page: Settable[A], value: A)(implicit writes: Writes[A]): Try[EnrolmentUserAnswers] = {
  ...
  def remove[A](page: Settable[A]): Try[EnrolmentUserAnswers] = {
...
object EnrolmentUserAnswers {

  implicit val format: OFormat[EnrolmentUserAnswers] = (
