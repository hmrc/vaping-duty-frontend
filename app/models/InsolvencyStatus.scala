...
enum InsolvencyStatus(val value: String):
  case Insolvent  extends InsolvencyStatus("Y")
  case Solvent    extends InsolvencyStatus("N")
...
object InsolvencyStatus:
  ...
  given format: Format[InsolvencyStatus] = Format(reads, writes)