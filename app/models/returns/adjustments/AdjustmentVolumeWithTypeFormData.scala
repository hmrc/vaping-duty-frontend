...
final case class AdjustmentVolumeWithTypeFormData(
...
object AdjustmentVolumeWithTypeFormData {
  implicit val format: OFormat[AdjustmentVolumeWithTypeFormData] = Json.format[AdjustmentVolumeWithTypeFormData]
}
