...
trait Formatters {
  ...
  private[mappings] def stringFormatterWithSpaces(errorKey: String, args: Seq[String] = Seq.empty): Formatter[String] = new Formatter[String] {
