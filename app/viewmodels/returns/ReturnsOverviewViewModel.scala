...
case class ReturnsOverviewViewModel(
  outstandingReturns: Seq[OutstandingReturnRow],
  completedReturns: Seq[CompletedReturnRow]
)

object ReturnsOverviewViewModel {
  ...
  def apply(obligationsResponse: ObligationsResponse)(implicit messages: Messages): ReturnsOverviewViewModel = {
    ...
    ReturnsOverviewViewModel(
      outstandingReturns = outstandingObligations,
      completedReturns = completedObligations
    )
  }
