...
@Singleton
class EnrolmentUserAnswersRepository @Inject()(
                                    mongoComponent: MongoComponent,
                                    appConfig: FrontendAppConfig,
                                    clock: Clock
                                  )(implicit ec: ExecutionContext)
  extends PlayMongoRepository[EnrolmentUserAnswers](
    collectionName = "user-answers",
    mongoComponent = mongoComponent,
    domainFormat = EnrolmentUserAnswers.format,
    indexes = Seq(
      IndexModel(
  ...
  def set(answers: EnrolmentUserAnswers): Future[Boolean] = {
