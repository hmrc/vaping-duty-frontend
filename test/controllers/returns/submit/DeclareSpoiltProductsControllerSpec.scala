...
import forms.returns.{DeclareDutyFormProvider, DeclareSpoiltProductsFormProvider}
...
import views.html.returns.submit.{DeclareDutyView, DeclareSpoiltProductsView}
