...
import pages.returns.adjustments.DeclareAdjustmentPage
...
import views.html.returns.submit.adjustments.DeclareAdjustmentQuestionView
...
class DeclareAdjustmentQuestionControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val declareAdjustmentQuestionRoute: String = 
  ...
  "DeclareAdjustmentQuestion Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      val userAnswers = returnsUserAnswers.set(DeclareAdjustmentPage, true).success.value
