...
class JourneyOutcomeSpec extends AnyFreeSpec with Matchers with TestData with SpecBase {
  ...
  "JourneyOutcome" - {
    ...
    val json = """{"timeStarted":"2026-02-12T11:13:06Z","credentialId":"cred-id","vpdId":"VPPAID01","originalContactPreference":"Email","originalContactPreferenceValue":"john.doe@example.com","contactPreferenceChange":"AmendEmailAddress","newContactPreference":{"newEmailAddress":"john.doe@example.com"}}"""
