...
class EnrolmentSessionRepositoryISpec
  extends AnyFreeSpec
    with Matchers
    with DefaultPlayMongoRepositorySupport[EnrolmentUserAnswers]
    with ScalaFutures
  ...
  protected override val repository: EnrolmentUserAnswersRepository = new EnrolmentUserAnswersRepository(
